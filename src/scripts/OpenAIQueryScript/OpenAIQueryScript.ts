...
export class OpenAIQueryScript implements VerificationScript {
    ...
    async execute(params: any): Promise<any> {
        ...
        const prompt = `${question}\n\n${text}\n\nPlease respond with a valid JSON object with exactly two keys: "result" (a boolean) and "comment" (a string). Do not include any markdown formatting or code fences—only output the JSON object.`;
        try {
